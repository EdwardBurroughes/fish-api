...
COPY fish_survey (id, survey_id, event_date, event_date_year, survey_ranked_easting, survey_ranked_northing, species_id, area_id, fish_count)
FROM '/docker-entrypoint-initdb.d/data/fish_survey.csv' DELIMITER ',' CSV HEADER;

COPY fish_species (id, species_name, latin_name)
